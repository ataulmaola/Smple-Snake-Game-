...
dark_blue=pygame.Color(1,26,39) #score
...
def gameOver():
	...
	GOsurf=myFont.render('Game Over !', True,redish)
	GOrect=GOsurf.get_rect()
	GOrect.midtop=(360,15)
	playDisplay.blit(GOsurf,GOrect)
	showScore(0)
	pygame.display.flip()
	time.sleep(4)
	pygame.quit()
...
while True:
	...
	playDisplay.fill(ivory_white)

	for pos in snakeBody:
		pygame.draw.rect(playDisplay,forest_green,pygame.Rect(pos[0],pos[1],10,10))
	
	pygame.draw.rect(playDisplay,hot_pink,pygame.Rect(foodPos[0],foodPos[1],10,10))
